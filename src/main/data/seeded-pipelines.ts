...
export const AGENT_PIPELINE: SeededPipeline = {
  ...
  statuses: [
    ...
    { name: 'implementing', label: 'Implementing', category: 'agent_running', position: 3 },
    { name: 'pr_review', label: 'PR Review', category: 'human_review', position: 4 },
    { name: 'needs_info', label: 'Needs Info', category: 'waiting_for_input', position: 5 },
    { name: 'done', label: 'Done', isFinal: true, category: 'terminal', position: 6 },
  ],
  transitions: [
...
export const BUG_AGENT_PIPELINE: SeededPipeline = {
  ...
  statuses: [
    ...
    { name: 'implementing', label: 'Implementing', color: '#3b82f6', category: 'agent_running', position: 3 },
    { name: 'pr_review', label: 'PR Review', color: '#06b6d4', category: 'human_review', position: 4 },
    { name: 'needs_info', label: 'Needs Info', color: '#6b7280', category: 'waiting_for_input', position: 5 },
    { name: 'done', label: 'Done', color: '#22c55e', isFinal: true, category: 'terminal', position: 6 },
  ],
  transitions: [
    // Manual transitions
