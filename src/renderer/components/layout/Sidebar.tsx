...
import { LayoutDashboard, FolderOpen, CheckSquare, Layers, Workflow, Bot, Palette, GitBranch, Settings, Bug, SlidersHorizontal, MessageSquare, DollarSign, LayoutGrid } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/tasks/kanban', icon: LayoutGrid, label: 'Kanban' },
