...
export function CostPage() {
  ...
  const { data: chatCosts, loading: chatCostsLoading } = useIpc<{ inputTokens: number; outputTokens: number; cacheReadInputTokens: number; cacheCreationInputTokens: number; totalCostUsd: number }>(
