...
const SESSION_SELECT = `id, project_id as projectId, scope_type as scopeType, scope_id as scopeId, name, agent_lib as agentLib, model, source, agent_role as agentRole, agent_run_id as agentRunId, permission_mode as permissionMode, sidebar_hidden as sidebarHidden, system_prompt_append as systemPromptAppend, enable_streaming as enableStreaming, enable_streaming_input as enableStreamingInput, draft, created_at as createdAt, updated_at as updatedAt`;
    ...
    try {
      ...
      let sql = `
        SELECT cs.id, cs.project_id as projectId, cs.scope_type as scopeType, cs.scope_id as scopeId,
               cs.name, cs.agent_lib as agentLib, cs.model, cs.source, cs.agent_role as agentRole, cs.agent_run_id as agentRunId, cs.permission_mode as permissionMode, cs.sidebar_hidden as sidebarHidden, cs.system_prompt_append as systemPromptAppend, cs.enable_streaming as enableStreaming, cs.enable_streaming_input as enableStreamingInput, cs.draft, cs.created_at as createdAt, cs.updated_at as updatedAt,
