      ...
      schema: {
        ...
        properties: {
          ...
          codebaseImprovements: {
            type: 'array',
            items: { type: 'string' },
            description: 'Codebase-level improvements that would have prevented this defect — e.g. consolidating scattered constants, adding type safety, introducing shared abstractions, improving code organization, adding tests',
          },
          suggestedTasks: {
            type: 'array',
            items: {
