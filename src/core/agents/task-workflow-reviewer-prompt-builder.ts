          ...
          suggestedTasks: {
            ...
            items: {
              ...
              properties: {
                ...
                type: { type: 'string', enum: ['bug', 'feature', 'improvement'], description: 'Task type: bug (something broken, needs investigation), feature (new functionality), improvement (enhancement to existing)' },
                ...
                startPhase: { type: 'string', enum: ['investigating', 'designing', 'planning', 'implementing'], description: 'Recommended starting phase for this task' },
              },
